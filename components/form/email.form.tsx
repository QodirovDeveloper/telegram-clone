import { emailSchema, oldEmailSchema, otpSchema } from "@/lib/validation"
...
const EmailForm = () => {
  ...
  const emailForm = useForm<z.infer<typeof oldEmailSchema>>({
    ...
    defaultValues: { email: "", oldEmail: "info@qodirov.dev", },
  })
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="info@qodirov.dev" className="h-10 bg-secondary" {...field} />
              </FormControl>
              <FormMessage className="text-xs text-red-500" />
            </FormItem>
          )}
