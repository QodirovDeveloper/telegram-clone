import DangerZoneForm from "@/components/form/dangerZone.form"
      ...
      <Popover>
        ...
        <PopoverContent className="p-0 w-80">
          <h2 className="pt-2 pl-2 text-muted-foreground">
            Settings: <span className="text-white">info@qodirov.dev</span>
          </h2>
      ...
      <Sheet open={isProfileOpen} onOpenChange={setIsProfileOpen}>
        <SheetContent side="left" className="w-80 p-2">
          <SheetHeader>
            ...
            <SheetDescription>
              Settings up your profile will help you connect with your friends and family easily.
            </SheetDescription>
          </SheetHeader>
